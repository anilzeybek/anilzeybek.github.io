...
![](/assets/mnist.png){: .light-diagram }
...
![](/assets/token2_64.png){: .light-diagram }
...
![](/assets/16output.png){: .light-diagram width="1000" }
...
![](/assets/cls_only.png){: .light-diagram width="1000" }
